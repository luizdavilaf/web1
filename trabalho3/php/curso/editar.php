      ...
      <main class='container p-3 my-3 bg-dark text-white-50'>
        ...
        <form action="./editar2.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="sala" name="sala" value="<?php echo $sala; ?>">
          </div>
          <div class="form-group">
            <label for="professor">professor:</label>
            <input type="text" class="form-control" id="professor" name="professor" value="<?php echo $professor; ?>">
          </div>
          <div class="form-group">
            <label for="nome_turma">nome_turma:</label>
            <input type="text" class="form-control" id="nome_turma" name="nome_turma" value="<?php echo $nome_turma; ?>">
          </div>
